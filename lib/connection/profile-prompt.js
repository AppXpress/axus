...
/**
 * ProfilePrompt requires an Interface (as defined by node/readline).
 *
...
class ProfilePrompt {
  ...
  static newPrompt(outstream) {
    return new ProfilePrompt(Streams.getMutableInterface(outstream));
  }
  ...
  prompt() {
    throw new TypeError('Subclasses must implement this method');
  }
